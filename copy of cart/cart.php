		...
		//query item type.if type is golve do this else regulear pull from data base
			...
			while ($row= mysql_fetch_array($resutls))	{
				...
				$gctRed=$row['tipRed'];
 				...
 				$gctGreen=$row['tipGreen'];
				
 				$gctBlue=$row['tipBlue'];
				
 				$gcRed=$row['gloveRed'];
				
 				$gcGreen=$row['gloveGreen'];
				
 				$gcBlue=$row['gloveBlue'];
...
<input type="hidden" name="custom_'.$x.'" value="'.$colors.'">
				...
				<article>
					  ...
					  <div id="pageContent">
					  	<div style="margin:24px; text-align:left;">
					  		...
					  		<table border="1" background-color="white" cellpadding="1" cellspacing="6">
